...
function sync(){
 ...
 for(const l of lowVoltageLayers){const show=shouldShow(l,detail,deepFlow,active,flowOn,cableOn);if(show){if(!map.hasLayer(l))l.addTo(map)}else if(map.hasLayer(l))map.removeLayer(l)}
