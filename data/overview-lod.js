...
function colorBaseLine(l){
 if(!l?.feature)return;
 l.setStyle({color:typeof assetColor!=='undefined'?assetColor:'#8293a3',opacity:l.__lodKind==='cable'?.68:.82,weight:typeof lineWeight==='function'?lineWeight(l.feature.properties):2});
}
