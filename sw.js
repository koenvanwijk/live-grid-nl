const STATIC_CACHE='nl-grid-static-v14';
const RUNTIME_CACHE='nl-grid-runtime-v14';
const STATIC_ASSETS=['./','./index.html','./styles.css?v=12','./app.js?v=12','./data/performance-canvas.js?v=2','./data/interconnectors.js?v=4','./data/injections.js?v=5','./data/interconnector-flow.js?v=1','./data/flow-particles.js?v=5','./data/overview-lod.js?v=3','./manifest.webmanifest','./icon.svg'];
