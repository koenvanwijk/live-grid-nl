const STATIC_CACHE='nl-grid-static-v8';
const RUNTIME_CACHE='nl-grid-runtime-v8';
const STATIC_ASSETS=['./','./index.html','./styles.css?v=11','./app.js?v=10','./data/interconnectors.js?v=2','./data/injections.js?v=3','./data/interconnector-flow.js?v=1','./data/flow-particles.js?v=4','./data/performance.js?v=1','./manifest.webmanifest','./icon.svg'];
