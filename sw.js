const STATIC_CACHE='nl-grid-static-v1';
const RUNTIME_CACHE='nl-grid-runtime-v1';
const STATIC_ASSETS=['./','./index.html','./styles.css?v=8','./app.js?v=9','./data/interconnectors.js?v=1','./data/injections.js?v=1','./manifest.webmanifest','./icon.svg'];
